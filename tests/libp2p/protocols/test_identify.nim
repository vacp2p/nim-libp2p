...
suite "Identify":
  ...
  suite "handle push identify message":
    ...
    asyncSetup:
      ...
      switch1 = newStandardSwitchBuilder().withAddresses(ma).withSignedPeerRecord(true).build()
      switch2 = newStandardSwitchBuilder().withAddresses(ma).withSignedPeerRecord(true).build()
