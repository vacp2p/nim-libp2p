...
proc replenishMesh(g: GossipSub, topic: string) {.async, gcsafe.} = 
...
method subscribe*(g: GossipSub,
  ...
  await procCall FloodSub(g).subscribe(topic, handler)
  asyncCheck g.replenishMesh(topic)
