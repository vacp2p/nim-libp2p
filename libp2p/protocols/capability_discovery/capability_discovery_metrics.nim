...
declarePublicCounter cd_messages_received, "capability discovery messages received", ["type"]
declarePublicCounter cd_message_bytes_sent, "capability discovery message bytes sent", ["type"]
declarePublicCounter cd_message_bytes_received, "capability discovery message bytes received", ["type"]
...
declarePublicCounter cd_register_responses, "registration responses received", ["status"]
...
declarePublicCounter cd_registrar_ads_expired, "advertisements expired from registrar cache"
...
declarePublicCounter cd_service_table_insertions, "peer insertions into service routing tables"

# IpTree metrics
declarePublicGauge cd_iptree_unique_ips, "unique IPs tracked in the IP tree"

# Advertiser metrics
declarePublicGauge cd_advertiser_pending_actions, "pending registration actions in queue"
...
declarePublicCounter cd_advertiser_services_removed, "services removed from advertisement"
