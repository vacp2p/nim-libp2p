...
proc newStandardSwitch*(privKey = none(PrivateKey),
                        ...
                        triggerSelf = false,
                        gossip = false,
                        validationTimeout = ValidationTimeout): Switch =
  ...
  let
    ...
    pubSub = if gossip: PubSub newPubSub(GossipSub, peerInfo, triggerSelf, validationTimeout)
             else: PubSub newPubSub(FloodSub, peerInfo, triggerSelf, validationTimeout)
