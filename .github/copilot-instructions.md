...
- Usage of `AsyncLock` must always be docummented. Provide a clear explanation of why the lock is required in that context. This ensures that locking decisions are transparent, justified, and maintainable.
