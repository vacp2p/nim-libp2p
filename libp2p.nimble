...
requires "nim >= 2.0.0",
  "nimcrypto >= 0.6.0", "dnsclient >= 0.3.0 & < 0.4.0", "bearssl >= 0.2.5", "chronicles >= 0.11.0", "chronos >= 4.0.4", "metrics", "secp256k1", "websock >= 0.2.1", "json_serialization >= 0.4.2", "unittest2", "results",
